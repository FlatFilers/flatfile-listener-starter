...
__export(src_exports, {
  SchemaILFieldtoProperty: () => SchemaILFieldtoProperty,
  SchemaILModelToSheetConfig: () => SchemaILModelToSheetConfig,
  SchemaILToJsonSchema: () => SchemaILToJsonSchema,
  compileEnum: () => compileEnum,
  compileLinkedField: () => compileLinkedField,
  compileSpecific: () => compileSpecific,
...
(function(map2) {
  ...
  map2.lazy = _lazy2(false);
  map2.lazyIndexed = _toLazyIndexed(_lazy2(true));
})(map || (map = {}));
...
var compileEnum = (inputField) => {
  const retVal = __spreadProps(__spreadValues({
    type: "string",
...
var compileLinkedField = (inputField) => {
  const retVal = __spreadValues({
    type: "schema_ref",
    label: inputField.label,
    upsert: void 0,
...
var compileSpecific = (inputField) => {
...
var SchemaILToJsonSchema = (ddl) => {
  ...
  const properties = pipe(
    fields,
    map(
      (f) => tuple(f.field, __spreadProps(__spreadValues({}, pick(f, [
        "type",
        "label",
        "field",
        "enum",
...
// src/BlueprintConvert.ts
var import_lodash = __toESM(require_lodash());
var getConstraints = (field) => {
  var _a;
  return import_lodash.default.filter([
    field.required ? { type: "required" } : null,
    field.unique ? { type: "unique" } : null,
    ((_a = field == null ? void 0 : field.stageVisibility) == null ? void 0 : _a.mapping) === false ? { type: "computed" } : null
  ]);
};
var convertBase = (field) => {
  var _a, _b;
  if (((_a = field == null ? void 0 : field.stageVisibility) == null ? void 0 : _a.review) === false) {
    console.warn("stageVisibility is not yet supported by X");
  }
  if (((_b = field == null ? void 0 : field.stageVisibility) == null ? void 0 : _b.export) === false) {
    console.warn("stageVisibility is not yet supported by X");
  }
...
var getEnumOptions = (field) => {
  return import_lodash.default.map(
    field.labelEnum,
    ({ value, label }) => ({ value, label })
  );
};
var convertEnum = (field) => {
...
var SchemaILFieldtoProperty = (field) => {
  const ft = field.type;
  if (ft === "string" || ft === "boolean" || ft === "number" || ft === "composite") {
...
var SchemaILModelToSheetConfig = (model) => {
  if (model.allowCustomFields === true) {
    console.warn(
      "X doesn't yet support 'allowCustomFields', behavior may be unepxected"
    );
  }
  const fields = import_lodash.default.values(model.fields).map(SchemaILFieldtoProperty);
  return {
    fields,
    slug: model.slug,
    name: model.name,
