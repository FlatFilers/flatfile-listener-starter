 ...
 */
export declare type Event = Flatfile.Event.SpaceAdded | Flatfile.Event.SpaceRemoved | Flatfile.Event.WorkbookAdded | Flatfile.Event.WorkbookRemoved | Flatfile.Event.UserAdded | Flatfile.Event.UserRemoved | Flatfile.Event.UserOnline | Flatfile.Event.UserOffline | Flatfile.Event.UploadStarted | Flatfile.Event.UploadFailed | Flatfile.Event.UploadCompleted | Flatfile.Event.JobStarted | Flatfile.Event.JobWaiting | Flatfile.Event.JobUpdated | Flatfile.Event.JobFailed | Flatfile.Event.JobCompleted | Flatfile.Event.JobDeleted | Flatfile.Event.RecordsCreated | Flatfile.Event.RecordsUpdated | Flatfile.Event.RecordsDeleted | Flatfile.Event.SheetValidated | Flatfile.Event.ActionTriggered | Flatfile.Event.FileDeleted | Flatfile.Event.ClientInitialized;
