...
class Jobs {
    ...
    async list(request = {}) {
        ...
        const _response = await core.fetcher({
            url: (0, url_join_1.default)(this.options.environment ?? environments.FlatfileEnvironment.Production, "/jobs"),
            method: "GET",
            headers: {
    ...
    async get(jobId) {
        const _response = await core.fetcher({
            url: (0, url_join_1.default)(this.options.environment ?? environments.FlatfileEnvironment.Production, `/jobs/${await serializers.JobId.jsonOrThrow(jobId)}`),
            method: "GET",
            headers: {
                Authorization: await this._getAuthorizationHeader(),
            },
    ...
    async execute(jobId) {
        const _response = await core.fetcher({
            url: (0, url_join_1.default)(this.options.environment ?? environments.FlatfileEnvironment.Production, `/jobs/${jobId}/execute`),
            method: "POST",
            headers: {
                Authorization: await this._getAuthorizationHeader(),
            },
     ...
     */
    async getExecutionPlan(jobId) {
        const _response = await core.fetcher({
            url: (0, url_join_1.default)(this.options.environment ?? environments.FlatfileEnvironment.Production, `/jobs/${await serializers.JobId.jsonOrThrow(jobId)}/plan`),
            method: "GET",
            headers: {
                Authorization: await this._getAuthorizationHeader(),
            },
     ...
     */
    async updateExecutionPlan(jobId, request) {
        const _response = await core.fetcher({
            url: (0, url_join_1.default)(this.options.environment ?? environments.FlatfileEnvironment.Production, `/jobs/${await serializers.JobId.jsonOrThrow(jobId)}/plan`),
            method: "PUT",
            headers: {
     ...
     */
    async updateExecutionPlanFields(jobId, request) {
        const _response = await core.fetcher({
            url: (0, url_join_1.default)(this.options.environment ?? environments.FlatfileEnvironment.Production, `/jobs/${jobId}/plan`),
            method: "PATCH",
            headers: {
                Authorization: await this._getAuthorizationHeader(),
            },
