...
class Sheets {
    ...
    async list(request) {
        ...
        const _response = await core.fetcher({
            url: (0, url_join_1.default)(this.options.environment ?? environments.FlatfileEnvironment.Production, "/sheets"),
            method: "GET",
            headers: {
    ...
    async get(sheetId, request) {
        ...
        _queryParams.append("workbookId", workbookId);
        const _response = await core.fetcher({
            url: (0, url_join_1.default)(this.options.environment ?? environments.FlatfileEnvironment.Production, `/sheets/${await serializers.SheetId.jsonOrThrow(sheetId)}`),
            method: "GET",
            headers: {
                Authorization: await this._getAuthorizationHeader(),
            },
     ...
     */
    async validate(sheetId) {
        const _response = await core.fetcher({
            url: (0, url_join_1.default)(this.options.environment ?? environments.FlatfileEnvironment.Production, `/sheets/${await serializers.SheetId.jsonOrThrow(sheetId)}/validate`),
            method: "GET",
            headers: {
                Authorization: await this._getAuthorizationHeader(),
            },
     ...
     */
    async getRecordsAsCsv(sheetId, request = {}) {
        ...
        const _response = await core.fetcher({
            url: (0, url_join_1.default)(this.options.environment ?? environments.FlatfileEnvironment.Production, `/sheets/${await serializers.SheetId.jsonOrThrow(sheetId)}/download`),
            method: "GET",
            headers: {
                Authorization: await this._getAuthorizationHeader(),
            },
     ...
     */
    async getRecordCounts(sheetId, request = {}) {
        ...
        const _response = await core.fetcher({
            url: (0, url_join_1.default)(this.options.environment ?? environments.FlatfileEnvironment.Production, `/sheets/${await serializers.SheetId.jsonOrThrow(sheetId)}/counts`),
            method: "GET",
            headers: {
                Authorization: await this._getAuthorizationHeader(),
            },
