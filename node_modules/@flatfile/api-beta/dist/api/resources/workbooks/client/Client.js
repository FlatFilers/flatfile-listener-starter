...
class Workbooks {
    ...
    async list(request = {}) {
        ...
        const _response = await core.fetcher({
            url: (0, url_join_1.default)(this.options.environment ?? environments.FlatfileEnvironment.Production, "/workbooks"),
            method: "GET",
            headers: {
    ...
    async get(workbookId) {
        const _response = await core.fetcher({
            url: (0, url_join_1.default)(this.options.environment ?? environments.FlatfileEnvironment.Production, `/workbooks/${await serializers.WorkbookId.jsonOrThrow(workbookId)}`),
            method: "GET",
            headers: {
                Authorization: await this._getAuthorizationHeader(),
            },
