...
class Files {
    ...
    async list(request = {}) {
        ...
        const _response = await core.fetcher({
            url: (0, url_join_1.default)(this.options.environment ?? environments.FlatfileEnvironment.Production, "/files"),
            method: "GET",
            headers: {
    ...
    async get(fileId) {
        const _response = await core.fetcher({
            url: (0, url_join_1.default)(this.options.environment ?? environments.FlatfileEnvironment.Production, `/files/${fileId}`),
            method: "GET",
            headers: {
                Authorization: await this._getAuthorizationHeader(),
            },
    ...
    async download(fileId) {
        const _response = await core.fetcher({
            url: (0, url_join_1.default)(this.options.environment ?? environments.FlatfileEnvironment.Production, `/files/${await serializers.FileId.jsonOrThrow(fileId)}/download`),
            method: "GET",
            headers: {
                Authorization: await this._getAuthorizationHeader(),
            },
