...
function objectMatches(object, filter) {
  ...
  for (const x in filter) {
    const prop = object[x];
    if (!(object == null ? void 0 : object[x])) {
      return false;
    }
...
var EventHandler = class extends AuthenticatedClient {
  ...
  dispatchEvent(event) {
    return __async(this, null, function* () {
      ...
      yield this.trigger(event);
      for (const node of this.nodes) {
        yield node.dispatchEvent(event);
      }
    });
  }
  /**
    ...
    setInterval(() => {
      this.handler.api.getEvents({
        ...
        process.stdout.write(
          `\u2192 checked events at ${lastTimestamp.toISOString()} \u2014 ${((_a = res.data) == null ? void 0 : _a.length) || 0} found
`
        );
        (_b = res.data) == null ? void 0 : _b.forEach((e) => {
