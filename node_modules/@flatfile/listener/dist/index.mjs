...
function EnvironmentFromJSONTyped(json, ignoreDiscriminator) {
  ...
  return {
    ...
    "name": json["name"],
    "isProd": json["isProd"],
    "newSpacesInherit": !exists(json, "newSpacesInherit") ? void 0 : json["newSpacesInherit"],
...
function EnvironmentConfigToJSON(value) {
  ...
  return {
    "name": value.name,
    "isProd": value.isProd,
    "newSpacesInherit": value.newSpacesInherit,
...
function JobStatsAccountsFromJSONTyped(json, ignoreDiscriminator) {
  ...
  return {
    "leastAbandonedJobs": !exists(json, "leastAbandonedJobs") ? void 0 : json["leastAbandonedJobs"],
