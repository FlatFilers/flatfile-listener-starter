...
__export(build_exports, {
  ...
  EnvironmentConfigGuestAuthenticationEnum: () => EnvironmentConfigGuestAuthenticationEnum,
  ...
  EnvironmentGuestAuthenticationEnum: () => EnvironmentGuestAuthenticationEnum,
  ...
  JobConfigOperationEnum: () => JobConfigOperationEnum,
  ...
  JobOperationEnum: () => JobOperationEnum,
...
var EnvironmentGuestAuthenticationEnum = {
...
var EnvironmentConfigGuestAuthenticationEnum = {
  SharedLink: "shared_link",
  MagicLink: "magic_link"
};
...
function instanceOfSpace(value) {
  let isInstance = true;
  isInstance = isInstance && "id" in value;
  isInstance = isInstance && "spaceConfigId" in value;
  isInstance = isInstance && "environmentId" in value;
  return isInstance;
}
...
var DefaultApi = class extends BaseAPI {
  ...
  async getEnvironmentsRaw(initOverrides) {
    const queryParameters = {};
    const headerParameters = {};
    if (this.configuration && this.configuration.accessToken) {
      const token = this.configuration.accessToken;
  ...
  async getEnvironments(initOverrides) {
...
0 && (module.exports = {
  ...
  EnvironmentConfigGuestAuthenticationEnum,
  EnvironmentConfigToJSON,
  EnvironmentFromJSON,
  EnvironmentFromJSONTyped,
  EnvironmentGuestAuthenticationEnum,
