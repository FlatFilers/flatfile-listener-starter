...
function JobUpdateConfigFromJSONTyped(json, ignoreDiscriminator) {
  ...
  return __spreadValues(__spreadValues(__spreadValues({}, DeleteJobConfigFromJSONTyped(json, true)), FileJobConfigFromJSONTyped(json, true)), PipelineJobConfigFromJSONTyped(json, true));
}
