...
var URL = Url.URL || import_whatwg_url.default.URL;
...
import {
  FlatfileRecord,
  FlatfileRecords as FlatfileRecords2
} from "@flatfile/hooks/";
var RecordTranslater = class {
  constructor(records) {
    this.records = records;
    this.toFlatFileRecords = () => {
      if (this.records instanceof FlatfileRecords2) {
        return this.records;
      } else {
        const XRecords = this.records;
        const FFRecords = new FlatfileRecords2(
          XRecords.map((record) => {
            var _a;
            let rawData = {};
...
import {
  FlatfileRecords as FlatfileRecords3,
  FlatfileSession as FlatfileSession2
} from "@flatfile/hooks";
var SheetTester = class {
  ...
  transformRecord(recordBatch) {
    return __async(this, null, function* () {
      var _a;
      const session = new FlatfileSession2(__spreadProps(__spreadValues({}, this.testSession), {
        schemaSlug: this.sheetName
      }));
      const iRaw = [{ rawData: recordBatch, rowId: 1 }];
      const inputRecords = new FlatfileRecords3(iRaw);
