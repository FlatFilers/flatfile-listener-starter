import Blueprint, { Action as Action$1, SheetConfig } from '@flatfile/blueprint';
import { DefaultApi, Event, Blueprint as Blueprint$1 } from '@flatfile/api';
import * as _flatfile_hooks from '@flatfile/hooks';
import { FlatfileRecords, FlatfileSession, FlatfileRecord, TPrimitive, TRecordData, IRecordInfo } from '@flatfile/hooks';
...
import { FlatfileEvent as FlatfileEvent$1 } from '@flatfile/listener';
...
type RecordsComputeType = (records: FlatfileRecords<any>, session?: FlatfileSession, logger?: any) => Promise<void>;
type RecordCompute = {
    dependsOn?: string[];
    uses?: string[];
    modifies?: string[];
...
declare class Sheet<FC extends FieldConfig> extends EventHandler implements Mountable {
    ...
    runProcess(records: FlatfileRecords<any>, session: FlatfileSession, logger: any): Promise<FlatfileRecords<any>>;
    ...
    prepareXRecords(records: any): Promise<FlatfileRecords<any>>;
...
declare class Workbook extends EventHandler implements Mountable {
    ...
    processRecords: (records: FlatfileRecords<any>, payload: IHookPayload, logger?: any) => Promise<FlatfileRecords<any>>;
...
declare const RecordHook: (event: FlatfileEvent$1, handler: (record: FlatfileRecord) => {}) => Promise<((record: FlatfileRecord) => {}) | undefined>;
